(() => {
  ...
  function renderDrawer(project) {
    ...
    const actionLinks = [];
    if (project.productVideo) {
      actionLinks.push(`<a class="btn btn--ghost" href="${esc(project.productVideo)}" target="_blank" rel="noopener noreferrer">
